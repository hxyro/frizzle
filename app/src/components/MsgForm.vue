...
const send = async () => {
  ...
  const msg = await sendMsg(effectiveTopic.value, content.value);
  emit("added", msg);
  topic.value = "";
  content.value = "";
};
    ...
    <div class="flex flex-wrap items-center justify-between -m-2">
      ...
      <div class="relative m-2 mr-4">
        <input
          type="text"
          placeholder="topic"
          class="text-green-400 focus:outline-none rounded-full pl-10 pr-4 py-2 bg-gray-800"
        ...
        <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
          <svg
            ...
            :class="effectiveTopic ? 'text-green-500' : 'text-gray-400'"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
